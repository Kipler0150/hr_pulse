...
END;
$$;
DROP TRIGGER IF EXISTS audit_events_context_defaults ON public.audit_events;
CREATE TRIGGER audit_events_context_defaults BEFORE INSERT ON public.audit_events FOR EACH ROW EXECUTE FUNCTION public.populate_audit_event_context();
