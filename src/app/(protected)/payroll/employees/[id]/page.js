  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <Card>
        ...
        <CardContent>{employee.status === "active" ? <form action={deactivateEmployeeAction}><input name="employeeId" type="hidden" value={employee.id} /><input name="expectedVersion" type="hidden" value={employee.version} /><Button type="submit" variant="destructive"><UserRoundXIcon data-icon="inline-start" />Deactivate employee</Button></form> : <Badge variant="secondary">Inactive employee</Badge>}</CardContent>
      </Card>
