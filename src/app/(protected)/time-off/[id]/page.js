...
export const metadata = { title: "Time off request | HR Pulse" };

export default async function TimeOffRequestPage({ params }) {
  ...
  return <RequestDetail context={context} detail={detail} />;
}
